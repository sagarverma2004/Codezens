...
function Abcodezens() {
    return (
        <>
            <section className="py-20 bg-[#0F0E0E] px-4 mb-80">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="text-white text-center md:text-left">
                        <motion.h1
                            ...
                            className="text-2xl md:text-5xl pb-2 ">
                            Why Codezens
                        </motion.h1>
                        <motion.p
                            initial={{ opacity: 0, y: 100, }}
                    ...
                    {/* Box */}
                    <div className="inline-grid grid-cols-1 md:grid-cols-3 pt-20 ">
                        ...
                        <motion.div
                            ...
                            <motion.h1
                                ...
                                transition={{ duration: 0.3, delay: 0.2 }}
                                viewport={{ once: true, amount: 0.2 }}
                                className="text-xl md:text-2xl pb-5">
                                Design That Works
                            </motion.h1>
                            <motion.p
                                initial={{ opacity: 0, y: 100, }}
                            ...
                            <ol className="list-disc pl-5 text-sm md:text-xs">
                                <motion.li
                                    initial={{ opacity: 0, y: 100, }}
                                    whileInView={{ opacity: 1, y: 0, }}
