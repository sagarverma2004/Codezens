  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center max-w-4xl px-4 mx-auto text-center">
        ...
        >
          Leverage cutting-edge artificial intelligence and machine learning technologies to optimize operations and unlock new growth opportunities.
        </motion.p>
