  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center max-w-4xl px-4 mx-auto text-center">
        ...
        >
          Reliable Maintenance & Support for Seamless Performance
        </motion.p>
        ...
        >
          Ensure uninterrupted operations with proactive maintenance and responsive support designed to keep your systems running at peak efficiency.
        </motion.p>
