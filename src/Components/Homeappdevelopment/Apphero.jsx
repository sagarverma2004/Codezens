  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center max-w-4xl px-4 mx-auto text-center">
        ...
        >
          App Development That Connects and Converts
        </motion.p>
        ...
        >
          High-performance mobile apps designed for seamless user experience,
          scalability, and real-world impact — from concept to deployment.
        </motion.p>
